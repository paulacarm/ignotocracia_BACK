...
/**
 * author paula.carmona.moreno /**Esta clase será la encargada de generar la
 * seguridad Tendrá los mismos atributos que la clase Usuario, excepuando el id.
 * En vez de tener roles tendrá authorities.(Clase propia de la seguridad de
 * Spring boot). Esta clase no es una entidad. No estará en la BD
 */
